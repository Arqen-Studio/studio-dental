          ...
          <div className="w-full max-w-[580px]">
            ...
            <form className="mt-8 flex flex-col gap-5" noValidate>
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="name" className="text-[0.82rem] text-ink2">
                    Your name
                  </label>
                  <input
                    id="name"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="phone" className="text-[0.82rem] text-ink2">
                    Your phone
                  </label>
                  <input
                    id="phone"
              ...
              {/* Email */}
              <div className="flex flex-col gap-1.5">
                <label htmlFor="email" className="text-[0.82rem] text-ink2">
                  Your email
                </label>
                <input
                  id="email"
              ...
              {/* Message */}
              <div className="flex flex-col gap-1.5">
                <label htmlFor="message" className="text-[0.82rem] text-ink2">
                  Message
                </label>
                <textarea
                  id="message"
