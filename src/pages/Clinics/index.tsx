  ...
  return (
    <>
      ...
      <section className="bg-[#f0efeb] pb-20">
        <div className="mx-auto w-full max-w-[1240px] px-5 md:px-8">
          <h2 className="mb-6 text-[clamp(1.6rem,3vw,2.2rem)] font-bold text-ink">
            Contacts
          </h2>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            {CLINICS.map((clinic) => (
              <div
                key={`simple-${clinic.id}`}
                className="rounded-xl bg-white p-7 shadow-soft-sm md:p-9"
              >
                <h3 className="mb-5 text-[1.6rem] font-bold text-ink">
                  {clinic.city}
                </h3>
                ...
                <div className="mt-5 flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-[0.88rem] text-ink2">
                ...
                <div className="mt-5 flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-[0.88rem] font-medium text-ink2">
                      Working hours:
                    </p>
                    {clinic.hours.map((h) => (
                      <p key={h} className="text-[0.92rem] text-ink">
                        {h}
                      </p>
                    ))}
                  </div>
