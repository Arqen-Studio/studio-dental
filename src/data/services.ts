...
/**
 * Stills from our own clinic footage in `public/videos`. Two of the images
 * these replaced were stock photographs of people, which read as though they
 * were our clinicians on a page about our treatments.
 */
const IMG_TREATMENT_ROOM = "/images/clinic/interior-b.jpg";
const IMG_LOUNGE         = "/images/clinic/interior-a.jpg";
const IMG_RECEPTION      = "/images/clinic/interior-c.jpg";
const IMG_CHAIR          = "/images/clinic/interior-d.jpg";
const IMG_INSTRUMENTS    = "/images/clinic/interior-e.jpg";
