          ...
          >
            {TEAM_DOCTORS.map((doctor) => (
              <article
                key={doctor.name}
                data-doctor-slide
                className="w-[min(196px,calc(100vw-2.5rem))] shrink-0 snap-start overflow-hidden rounded-xl border border-black/[0.06] bg-white shadow-[0_2px_12px_rgba(15,27,36,0.08)] transition-shadow duration-300 hover:shadow-[0_8px_24px_rgba(15,27,36,0.12)] sm:w-[210px]"
              >
