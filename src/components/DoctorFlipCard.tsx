    ...
    <div className="relative h-[480px] [transform-style:preserve-3d] transition duration-700 ease-out group-hover:[transform:rotateY(180deg)]">
      <div className="absolute inset-0 overflow-hidden rounded-lg border border-black/10 bg-creamBrand shadow-soft-sm [backface-visibility:hidden]">
        ...
        <div className="flex h-[256px] flex-col p-5">
          <h3 className="min-h-[2.6rem] text-[1.1rem] leading-tight text-[#83BFE3] [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:2] overflow-hidden">
            {name}
          </h3>
          <p className="mt-2 min-h-[4.4rem] text-[0.7rem] font-semibold uppercase tracking-[0.06em] text-skyBrand [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:5] overflow-hidden">
            {creds}
          </p>
      ...
      <div className="absolute inset-0 overflow-hidden rounded-lg border border-black/10 bg-ink text-creamBrand shadow-soft-md [transform:rotateY(180deg)] [backface-visibility:hidden]">
        ...
        <div className="relative z-10 flex h-full flex-col p-5">
          <div className="flex items-start">
            <div>
              <h3 className="text-[1.1rem] font-semibold text-[#83BFE3]">{name}</h3>
              <p className="mt-1 text-[0.66rem] font-semibold uppercase tracking-[0.07em] text-skyBrand [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:3] overflow-hidden">
                {creds}
              </p>
            </div>
          </div>
